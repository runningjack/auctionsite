...
class HomeController extends BaseController {
	...
	*/
    ...
    public $image_relative_path     ="http://medicalequipment-ngi.com/uploads/images/";
    //public $url  = url("/");
    ...
    public function index()
    {
        ...
        $latestproducts =DB::table('products')
            ->orderBy('created_at', 'desc')->skip(4)->take(8)
            //
            ->get();
    ...
    public function postCheckout(){
        ...
        if($order->save()){
            ...
            Mail::send('emails.orderconfirmation', $input, function($message) use($input) {
                $message->from("orders@medicalequipment-ng.com", "Medical Equipment NG");
                $message->to($input['email'], "order@medicalequipment-ng.com")->cc('ahmed@chroniclesoft.com')->subject("Order Confirmation: ". $input['invoice_no']);
            });
                ...
                try {
                    ...
                    if($validator->passes()){
                        ...
                        Mail::send('emails.contactus', $input, function($message) use($input) {
                            $message->from($input['email'], "medicalequipment-ng.com Contact Page ". $input['name']);
                            $message->to("info@medicalequipment-ng.com", "Medical Equipment NG")->cc('amedora09@gmail.com')
