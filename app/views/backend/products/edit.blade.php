                    ...
                    <div id="myTabContent1" class="tab-content padding-10">
                        ...
                        <div class="tab-pane fade" id="s2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" placeholder="Buying Price" id="price" name="price" type="text" value="{{$myproduct->price}}" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" placeholder="Opening Price" id="open_price" name="open_price" type="text" value="{{$myproduct->open_price}}" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input class="form-control" placeholder="Lowest Price to Accept" id="lowest_price" name="lowest_price" type="text" value="{{$myproduct->lowest_price}}" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" placeholder="Increament Value" id="inc_value" name="inc_value" type="text" value="{{$myproduct->inc_value}}" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input placeholder="End Date" id="end_date" name="end_date" type="date" value="{{$myproduct->end_date}}" placeholder="Select a date" class="form-control datepicker hasDatepicker" data-dateformat="dd/mm/yy" >
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" placeholder="Time" id="end_time" value="{{$myproduct->end_time}}" name="end_time" type="text" autocomplete="off">
