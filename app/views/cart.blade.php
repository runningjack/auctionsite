    ...
    <div id="content">
            ...
            <table class="shop_table beta-shopping-cart-table" cellspacing="0">
                ...
                if($content){
                    ...
                    <td class='product-quantity'>
                        ...
                        <a href='javascript:void(0)' price='".$itemRow->price."' rowid='".$itemRow->rowid."' pid='".$itemRow->id."' class='update-product' title='update this item'><i class='fa fa-refresh'></i></a>
                    </td>

                    <td class='product-subtotal'>
                        <span class='amount' data-cart='".$itemRow->price*$itemRow->qty."'>&#8358;".number_format($itemRow->price*$itemRow->qty,2,".",",")."</span>
                    </td>

                    <td class='product-remove'>
                        <a href='javascript:void(0)' data-cart='".$itemRow->price*$itemRow->qty."'  price='".$itemRow->price."' rowid='".$itemRow->rowid."' pid='".$itemRow->id."' class='remove' title='Remove this item'><i class='fa fa-trash-o'></i></a>
                    </td>
                </tr>
                        ";
                        $x++;
                ...
                <tr>
                    <td colspan="6" class="actions">
                        ...
                        <a href="{{ASSETS_URL}}/checkout" class="beta-btn primary">Proceed to Checkout<i class="fa fa-chevron-right"></i></a>
        ...
        <div class="cart-collaterals">
            ...
            <div class="cart-totals pull-right">
                ...
                <div class="cart-totals-row"><span>Cart Subtotal:</span> <span id="cart-subtotal" data-cart="{{Cart::total()}}">&#8358;{{number_format(Cart::total(),2,".",",")}}</span></div>
                <div class="cart-totals-row"><span>Shipping:</span> <span>Free Shipping</span></div>
                <div class="cart-totals-row"><span>Order Total:</span> <span id="cart-total" data-cart="{{Cart::total()}}">&#8358;{{number_format(Cart::total(),2,".",",")}}</span></div>
            </div>
