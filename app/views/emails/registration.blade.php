            ...
            <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTextContentContainer" width="100%" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0">
                ...
                <tr>
                    <td class="kmTextContent" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;color:#505050;font-family:Helvetica, Arial;font-size:14px;line-height:150%;text-align:left;padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
                        <p>Dear {{$firstname}},</p>
                        <p style="margin:0;padding-bottom:1em">Thank you for registering with Medicalequipment.com!</p>
            ...
            <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTextContentContainer" width="100%" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0">
                ...
                <tr>
                    <td class="kmTextContent" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;color:#505050;font-family:Helvetica, Arial;font-size:14px;line-height:150%;text-align:left;padding-top:9px;padding-bottom:18px;padding-left:18px;padding-right:18px;">
                        <p>On <a href="{{url()}}"> Medicalequipment-ng.com</a>, you can purchase all your medical needs at wholesale price, and have them shipped directly to your clinic or
                        hospital anywhere in Nigeria! You can also pick up your equipment if you prefer at any of our pick stores across the country.</p>

                        <p>Along with flexible options to pay with a credit card or cash on delivery,
                        Medical Equipment NG offers fantastic customer service, great prices, free returns and quality products that come with warranties.
                        Enjoy an awesome shopping experience 24hours a day, 7 days a week!.</p>

                        <p>If you need any assistance or have any inquiry or suggestion, feel free to contact us at info@medicalequipment-ng.com</p>
                    </td>
                </tr>
                </tbody>
            </table>
